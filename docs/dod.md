...
- Acceptance criteria for the task are met, or remaining work is noted in a follow-up issue.
...
- For HTTP API changes, generated OpenAPI documentation (`/docs`) matches the handlers.
